...
class _StandUpState extends State<StandUp> with SingleTickerProviderStateMixin, WidgetsBindingObserver {
  ...
  Future<List<dynamic>> getStandUpUser() async {
    ...
    final String baseUrl =
        'https://testing.impstudio.id/approvall/api/standup?id=$userId';
                        ...
                        children: [
                          ...
                          GestureDetector(
                            onTap: () {
                              // setState(() {
                              //   activeIndex = 0;
                              //   standUpData = getStandUpUser(onlyCurrentUser: false);
                              // });
                            },
                            child: Container(
                                ...
                                onTap: () {
                                  if (currentUser == itemData['user_id']) {
                                    ...
                                    Navigator.push(
                                      ...
                                      MaterialPageRoute(
                                          builder: (context) =>
                                              DetailStandUp(standup: itemData)),
                                    );
                                  }
                                },
                                child: Container(
