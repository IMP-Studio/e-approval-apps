...
//   const FacePagePerjadin({Key? key, required this.profile}) : super(key: key);
...
//       // Assuming updateWorktrip() returns a Future, we need to await it to ensure it completes
//       await updateWorktrip(
//   // presenceId: yourPresenceIdHere,
