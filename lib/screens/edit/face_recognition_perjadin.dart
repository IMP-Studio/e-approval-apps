...
class FacePagePerjadin extends StatefulWidget {
  ...
  final Map<String, dynamic> presenceId; 

  const FacePagePerjadin({Key? key, required this.profile, required this.presenceId}) : super(key: key);
...
class _FacePagePerjadinState extends State<FacePagePerjadin>
  ...
  Future<void> _storeAndNavigate() async {
    ...
    try {
      ...
      print('Before updateWorktrip()');

      await updateWorktrip(
presenceId: widget.presenceId!['presence_id'],
  ...
  Future<void> updateWorktrip({
  required int presenceId,
  required DateTime entryTime,
  required double latitude,
  required double longitude,
  required Map<String, dynamic> facePointData,
}) async {
  // Encode the facePointData to a JSON string
  String jsonData = json.encode(facePointData);

  var uri = Uri.parse(
      'https://testing.impstudio.id/approvall/api/presence/update/worktrip/$presenceId');

  var request = http.MultipartRequest('POST', uri)
  
    ..headers['Content-Type'] = 'application/x-www-form-urlencoded' // Add this
     ..fields['_method'] ='PUT'
    ..fields['entry_time'] = DateFormat('HH:mm:ss').format(entryTime)
    ..fields['latitude'] = latitude.toString()
    ..fields['longitude'] = longitude.toString()
    ..fields['face_point'] = jsonData;
